...
O_FILE = *.lnk *.lst *.map *.mem *.rel *.rst *.sym
...
main.ihx : main.c time.rel seg.rel i2c.rel ad.rel key.rel
	$(CC) $(INC_FLAGS) $(CFLAGS) main.c time.rel seg.rel i2c.rel ad.rel key.rel
